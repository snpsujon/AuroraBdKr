                ...
                <div class="card-body h-100 w-100 z-3">
                    ...
                    <form method="POST" action="{{ route('install.db') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="db_host" name = "DB_HOST" value="{{ old('DB_HOST', $dbDefaults['DB_HOST'] ?? '') }}" required autocomplete="off">
                            <input type="hidden" name = "types[]" value="DB_HOST">
                        </div>
                        <div class="form-group">
                            <label for="db_name" class="fs-12 fw-500" style="color: #666;">Database Name</label>
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="db_name" name = "DB_DATABASE" value="{{ old('DB_DATABASE', $dbDefaults['DB_DATABASE'] ?? '') }}" required autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="db_user" name = "DB_USERNAME" value="{{ old('DB_USERNAME', $dbDefaults['DB_USERNAME'] ?? '') }}" required autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control rounded-2 border" style="height: 36px !important;" id="db_pass" name = "DB_PASSWORD" value="{{ old('DB_PASSWORD', $dbDefaults['DB_PASSWORD'] ?? '') }}" autocomplete="off">
                        ...
                        <div class="mb-4 pb-4 absolute-bottom-left right-0 d-flex justify-content-center">
                            @php
                                $route = \App\Http\Controllers\InstallController::shouldSkipPurchaseCodeStep() ? route('step1') : route('step2');
                            @endphp
