...
class UpdateController extends Controller
{
    public function step0(Request $request)
    {
        ...
        if (version_compare($current_version, '9.9.8', '<')) {
    ...
    {
        $versions = ['9.9.8'=>'v998.sql','9.9.9'=>'v999.sql','10.0.0'=>'v1000.sql','10.1.0'=>'v1010.sql','10.2.0'=>'v1020.sql','10.2.1'=>'v1021.sql','10.2.2'=>'v1022.sql','10.3.0'=>'v1030.sql','10.4.0'=>'v1040.sql','10.4.1'=>'v1041.sql','10.4.2'=>'v1042.sql','10.4.3'=>'v1043.sql','10.5.0'=>'v1050.sql','10.5.1'=>'v1051.sql'];
        
        $keys = array_keys($versions);
        $current_version = (get_setting('current_version') != null) ? get_setting('current_version') : '9.9.8';
