...
class InstallController extends Controller
{
    ...
    public function import_sql() {
        $this->streamImportSql(base_path('shop.sql'));
    ...
    public function import_sql_with_demo() {
        ...
        // import sql
        $this->streamImportSql(base_path('public/demo.sql'));
    ...
    /**
     * Import SQL without loading the full file in memory.
     */
    private function streamImportSql($sqlPath) {
